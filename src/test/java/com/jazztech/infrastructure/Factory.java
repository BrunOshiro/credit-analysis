...
public class Factory {
    ...
    public static CreditAnalysisEntity creditAnalysisEntityFactory() {
        return CreditAnalysisEntity.builder()
                .clientId(UUID.fromString("dd1efc87-a9c1-4f08-8fb7-1cd71d92dd6d"))
                .clientCpf("18784272023")
                .clientName("Lauren Ipson")
                .monthlyIncome(BigDecimal.valueOf(10000.00))
                .requestedAmount(BigDecimal.valueOf(5000.00))
                .approved(true)
                .approvedLimit(BigDecimal.valueOf(3000.00))
    ...
    public static ClientApiResponseDto clientApiDtoFactory() {
        return ClientApiResponseDto.builder()
                .id(UUID.fromString("dd1efc87-a9c1-4f08-8fb7-1cd71d92dd6d"))
                .nome("Lauren Ipson")
                .cpf("18784272023")
                .dataNascimento(LocalDate.parse("1993-01-01"))
                .clientApiAddressDto(ClientApiResponseDto.ClientApiAddressDto.builder()
